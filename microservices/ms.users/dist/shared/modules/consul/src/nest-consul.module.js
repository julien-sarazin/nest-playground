...
var NestConsulModule_1;
const common_1 = require("@nestjs/common");
const Consul = require("consul");
const nest_consul_service_1 = require("./nest-consul.service");
const constants_1 = require("./constants");
let NestConsulModule = NestConsulModule_1 = class NestConsulModule {
    static init(options) {
        ...
        const consulServiceProvider = {
            ...
            useFactory: (consulClient, consulConfiguration) => __awaiter(this, void 0, void 0, function* () {
                return new nest_consul_service_1.NestConsulService(consulClient, consulConfiguration);
            }),
            inject: [constants_1.CONSUL_CLIENT_PROVIDER, constants_1.CONSUL_CONFIGURATION_PROVIDER],
        };
        return {
            module: NestConsulModule_1,
            providers: [consulConfigurationProvider, consulClientProvider, consulServiceProvider],
            exports: [consulServiceProvider],
        };
    }
};
NestConsulModule = NestConsulModule_1 = __decorate([
    common_1.Global(),
    common_1.Module({})
], NestConsulModule);
exports.NestConsulModule = NestConsulModule;
//# sourceMappingURL=nest-consul.module.js.map